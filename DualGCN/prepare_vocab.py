...
def parse_args():
    ...
    parser.add_argument('--data_dir',default="./dataset/Laptops_corenlp", help='TACRED directory.')
    parser.add_argument('--vocab_dir',default="./dataset/Laptops_corenlp", help='Output vocab directory.')
